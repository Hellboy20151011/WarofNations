...
// Geldproduzierende Gebäudekosten laden und anzeigen
async function loadBuildingCosts() {
    try {
        const buildingCosts = await apiFetch('/api/buildings/money', 'GET');
        console.log('Money-producing building costs:', buildingCosts);
        ...
        buildingCosts.forEach(building => {
            ...
            descriptionElement.className = 'building-description';
            buildingDiv.appendChild(descriptionElement);
